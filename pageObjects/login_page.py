...
class Login_Page_Class:
    ...
    click_menu_button = "dropdown-toggle"
    ...
    def Click_menu_button(self):
            self.driver.find_element(By.CLASS_NAME,self.click_menu_button).click()
    ...
    def verify_menu(self):
        try:
            self.wait.until(expected_conditions.presence_of_element_located((By.CLASS_NAME,self.click_menu_button)))
            return "pass"
        except:
            return "Fail"
